		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">DETROIT <span>RISE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
						...
						<ul class="nav navbar-nav menu__list">
							<?php
								if(isset($_SESSION['user']))
								{
									...
									$users = $_SESSION['user'];
									echo '
									<li class="menu__item"><a href="" class="menu__link">'.$users.'</a></li>
									<li class="menu__item"><a href="../users/logout.php" class="menu__link">Sign out</a></li>
